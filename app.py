...
def home():
    ...
    db=Db()
    db.create_table(table_name='logins',cols=['user_id text','password text'])
    ...
    if request.method =='POST':
        ...
        if login:
            ...
            db.create_table(table_name=table_name,cols=['dates text','time text','subject text','hour int','present int'])
